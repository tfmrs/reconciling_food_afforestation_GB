...
vid = strrep(extractAfter(output_directory,strfind(output_directory,"vid_")+3),"/","")

help strfind

output_analysis = [output_analysis ; [ras_sub vid height(rolling_out_sim_tab) prawn_meat_price viability_rate RAS_units_average RAS_meat_production RAS_sub_total wood_created]]
