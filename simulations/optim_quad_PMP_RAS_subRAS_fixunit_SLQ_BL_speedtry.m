...
RAS_CAPEX_annuity = RAS_CAPEX*(g-d_turn_RAS_on*ras_sub)/NPV_RAS;
...
if  RAS_CAPEX*(g-d_turn_RAS_on*ras_sub)*(1-alpha)/(NPV_RAS*delta) <= NM_BL_LQ*d_turn_RAS_on
...
LQ_const = RAS_CAPEX*(g-d_turn_RAS_on*ras_sub)*((1-alpha)/NPV_RAS + alpha) <= (NM_AL_LQ + NM_BL_LQ)*d_turn_RAS_on;
