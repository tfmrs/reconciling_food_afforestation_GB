...
clearvars -except price_meat delta_out alpha_out irate_out d_SLR_RAS_out nOW_out disc_RAS_CAPEX_out type_sim name_sim timing cs_chitin cs_PLJ cs_feed cs_salt ras_sub input_directory output_directory midfile postsim_out ref_midfile timing r_inp_output_directory_1
cd(input_directory)
...
%        listoftabs = listoftabs(:,1)
        ...
        clearvars -except woodland_financial_tab listoftabs aggsolroll pixsolroll goal simulation EMcost_bro EMcost_con REV_bro REV_con C0_bro C0_con goal_Eng C0_bro ras_sub input_directory output_directory midfile postsim_out ref_midfile timing r_inp_output_directory_1
        %to get indexes (i)
...
clearvars -except input_directory output_directory midfile postsim_out ref_midfile timing r_inp_output_directory_1
%cd 'D:\Pesquisa\Pesquisa_2024\Sustainable_Prawn\Data\sim_RAS_general_dump\'
%cd 'D:\Pesquisa\Pesquisa_2024\Sustainable_Prawn\Data\sim_PMP_EE_AFRASTECHV_wageREP_wooddump\'
%cd 'D:\Pesquisa\Pesquisa_2024\Sustainable_Prawn\Data\sim_PMP_EE_woodquad_2grants\wooddump\'
...
clearvars -except rolling_out_sim_aside_update listofsimsup kjjj output_directory midfile postsim_out ref_midfile timing r_inp_output_directory_1
load(strcat(output_directory,midfile))
        output_directory = r_inp_output_directory_1
...
clearvars -except rolling_out_sim_RAS_update listofsimsup kjjj sim_name output_directory midfile postsim_out ref_midfile timing r_inp_output_directory_1
load(strcat(output_directory,midfile))
        output_directory = r_inp_output_directory_1
...
%save file
rolling_out_sim_RAS_update = table2array(rolling_out_sim_tab)
clearvars -except rolling_out_sim_RAS_update listofsimsup kjjj output_directory midfile postsim_out ref_midfile timing r_inp_output_directory_1
