...
%units is an integer.
vec_GM_RAS = round(1/vec_size_RAS)*(price_meat*RAS_yield_meat + price_chitin*RAS_yield_chitin -   155549.9129)
vec_GM_RAS_ex_lab = round(1/vec_size_RAS)*(price_meat*RAS_yield_meat + price_chitin*RAS_yield_chitin -  104168.22)
GM_RAS_ex_energy = (price_meat*RAS_yield_meat + price_chitin*RAS_yield_chitin - 145369.35)
GM_RAS_ex_energy_ex_labour = (price_meat*RAS_yield_meat + price_chitin*RAS_yield_chitin -  93987.66)
...
av_farm_area = readtable("D:\Pesquisa\Pesquisa_2024\Sustainable_Prawn\GIS\average_farm_area_Eurostat_2007_Censuses_26_03_24.txt")
