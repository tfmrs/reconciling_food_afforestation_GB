...
total_GHG_GB_prawn = array2table([total_GHG_GB_prawn (-1)*total_GHG_prawn_net_imports (-1)*total_GHG_RAS_grid_electricity (-1)*total_GHG_RAS_AD_electricity GHG_avoided_by_import_substitution])

total_GHG_GB_prawn.Properties.VariableNames = ["total_GHG_GB_prawn" "GHG_prawn_net_imports" "GHG_domestic_prawn_grid" "GHG_domestic_prawn_AD" "GHG_avoided_by_import_substitution"]
