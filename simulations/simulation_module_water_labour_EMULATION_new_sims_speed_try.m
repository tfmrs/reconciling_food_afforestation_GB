...
%cropless_&_forage
            if pixel_class == "crop_&_forage"
                optim_quad_PMP_RAS_for_MRU_sim_CAPEX_water_lab_SLQ_BL_speedtry
            else
                optim_quad_PMP_RAS_for_for_onl_CAPEX_water_lab_SLQ_BL_speedtry
            end    
...
%cropless_&_forage
            if pixel_class == "crop_&_forage"
                ...
                optim_quad_PMP_RAS_subRAS_fixunit_SLQ_BL_speedtry
            else
                %optim_quad_PMP_RAS_for_onl_subRAS_fixunit_SLQ_BL_08_01_25
                optim_quad_PMP_RAS_for_onl_subRAS_fixunit_SLQ_BL_speedtry
            end    
%            cd 'G:\LEEP\Sustainable_Prawn\Data\'
            %pixels without space for RAS in current g, exit RAS units loop
             if (string(exitflag_sim) == "NoFeasiblePointFound")
...
%                optim_quad_PMP_RAS_subRAS_fixutwo_SLQ_BL_05_06_25
                optim_quad_PMP_RAS_subRAS_fixutwo_SLQ_BL_speedtry

            else
                %optim_quad_PMP_RAS_for_onl_subRAS_fixunit_SLQ_BL_08_01_25
%                optim_quad_PMP_RAS_for_onl_subRAS_fixutwo_SLQ_BL_05_06_25
                optim_quad_PMP_RAS_for_onl_subRAS_fixutwo_SLQ_BL_speedtry
...
%        cd 'D:\Pesquisa\Pesquisa_2024\Sustainable_Prawn\'
    ...
    %cropless_&_forage
            if pixel_class == "crop_&_forage"
               optim_quad_PMP_RAS_for_MRU_speedtry_aside_subRAS_fixunit
            else
                optim_quad_PMP_RAS_for_MRU_speedtry_aside_nfo_subRAS_fixu
            end    
%            cd 'G:\LEEP\Sustainable_Prawn\Data\'
%pixels without space for RAS in current g, exit RAS units loop
             if (string(exitflag_sim) == "NoFeasiblePointFound")
...
%        cd 'D:\Pesquisa\Pesquisa_2024\Sustainable_Prawn\'
    ...
    %cropless_&_forage
            if pixel_class == "crop_&_forage"
               optim_quad_PMP_RAS_for_MRU_speedtry_aside_CAPEX_SLQ_BL_nocalcon
            else
                optim_quad_PMP_RAS_for_MRU_speedtry_aside_C_nfo_SLQ_BL_nocalcon
            end    
%            cd 'G:\LEEP\Sustainable_Prawn\Data\'
%pixels without space for RAS in current g, exit RAS units loop
             if (string(exitflag_sim) == "NoFeasiblePointFound")
...
%        cd 'D:\Pesquisa\Pesquisa_2024\Sustainable_Prawn\'
    ...
    %cropless_&_forage
            if pixel_class == "crop_&_forage"
               optim_quad_PMP_RAS_for_MRU_speedtry_aside_subRAS_fixtwo
            else
                optim_quad_PMP_RAS_for_MRU_speedtry_aside_nfo_subR_fixtwo
            end    
%            cd 'G:\LEEP\Sustainable_Prawn\Data\'
%pixels without space for RAS in current g, exit RAS units loop
             if (string(exitflag_sim) == "NoFeasiblePointFound")
