...
r_inp_type_sim<<-"'RAS_subsidy_fixed_unit_two'"
r_inp_type_sim_mid<<-"'RAS_aside_nocalconst_sub_fix_unit_two_wq'"
...
source(paste(gsub("'","",r_inp_input_directory),"script_guess_prices_(RAS_subpol)_R_07_02_25_wageREP.R",sep=""))
...
if (r_inp_ras_sub > 1) {
simulator_inputs <- matrix(c(BEP_1,AVC_3_units) , ncol = 1)
} else {
