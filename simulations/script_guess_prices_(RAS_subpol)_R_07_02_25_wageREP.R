...
BEP_1 <- 1/RAS_yield_meat*((OPEX_ex_lab+ RAS_CAPEX_annuity_one_unit*(1-r_inp_ras_sub)/1) + labcost_RAS_step(1)/1 - price_chitin*RAS_yield_chitin)
BEP_2 <- 1/RAS_yield_meat*((OPEX_ex_lab+ RAS_CAPEX_annuity_one_unit*(2-r_inp_ras_sub)/2) + labcost_RAS_step(2)/2 - price_chitin*RAS_yield_chitin)
BEP_3 <- 1/RAS_yield_meat*((OPEX_ex_lab+ RAS_CAPEX_annuity_one_unit*(3-r_inp_ras_sub)/3) + labcost_RAS_step(3)/3 - price_chitin*RAS_yield_chitin)
BEP_4 <- 1/RAS_yield_meat*((OPEX_ex_lab+ RAS_CAPEX_annuity_one_unit*(4-r_inp_ras_sub)/4) + labcost_RAS_step(4)/4 - price_chitin*RAS_yield_chitin)
...
AVC_10_units<-(OPEX_ex_lab_for_AVC*10 + labcost_RAS_step(10) * min(mat_wage_PAYE$ratio_final)/mean(mat_wage_PAYE$ratio_final) + RAS_CAPEX_annuity_one_unit*(10-r_inp_ras_sub))/(6624*10)


AVC_10_units_mean<-(OPEX_ex_lab_for_AVC*10 + labcost_RAS_step(10) + RAS_CAPEX_annuity_one_unit*10)/(6624*10)

AVC_3_units<-(OPEX_ex_lab_for_AVC*10 + labcost_RAS_step(10) * min(mat_wage_PAYE$ratio_final)/mean(mat_wage_PAYE$ratio_final) + RAS_CAPEX_annuity_one_unit*(10-3))/(6624*10)

if (r_inp_ras_sub > 1) {
BEP_1 <- 1/RAS_yield_meat*((OPEX_ex_lab+ RAS_CAPEX_annuity_one_unit*0) + labcost_RAS_step(1)/1 - price_chitin*RAS_yield_chitin)
}
